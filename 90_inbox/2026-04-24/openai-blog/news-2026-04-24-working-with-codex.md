# news-2026-04-24-working-with-codex

Automation: NewsIngest/v1
SourceID: openai-blog
SourceURL: https://openai.com/academy/working-with-codex
...
## Why It Matters
Source signal: Learn how to set up your Codex workspace, create threads and projects, manage files, and start completing tasks with step-by-step guidance.
